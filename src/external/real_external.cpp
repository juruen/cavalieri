...
{
  rates_.push_back(instr.add_rate(k_forward_service,
                                  k_forward_description));

  rates_.push_back(instr.add_rate(k_graphite_service,
                                  k_graphite_description));

  rates_.push_back(instr.add_rate(k_pagerduty_service,
                                  k_pagerduty_description));

  rates_.push_back(instr.add_rate(k_email_service,
                                  k_email_description));
}
